...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    ...
    <td class=ti width=455><?php echo $dados["identificacao"]; ?> <?php echo isset($dados["cpf_cnpj"]) ? "<br>".$dados["cpf_cnpj"] : '' ?><br>
	<?php echo $dados["endereco"]; ?><br>
	<?php echo $dados["cidade_uf"]; ?><br>
    </td>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=298 height=12>
  <span class="campo"><?php echo $dados["cedente"]; ?></span></td>
...
documento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top colspan=3 height=12>
  <span class="campo">
  <?php echo $dados["numero_documento"]?>
  </span></td>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=134 height=12>
  <span class="campo">
  <?php echo $dados["data_vencimento"]?>
  </span></td>
...
<span class="campo">
  <?php echo $dados["demonstrativo1"]?><br>
  <?php echo $dados["demonstrativo2"]?><br>
  <?php echo $dados["demonstrativo3"]?><br>
  </span>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left>
 ...
 <?php echo $dados["aceite"]?>
   ...
   <span class="campo">
   <?php echo $dados["data_processamento"]?>
...
<?php echo $dados["instrucoes1"]; ?><br>
<?php echo $dados["instrucoes2"]; ?><br>
<?php echo $dados["instrucoes3"]; ?><br>
<?php echo $dados["instrucoes4"]; ?></FONT><br><br>
</span></td>
...
mecânica - <b class=cp>Ficha de Compensação</b></div></TD></TR><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50><?php fbarcode($dados["codigo_barras"]); ?>
 </TD>
